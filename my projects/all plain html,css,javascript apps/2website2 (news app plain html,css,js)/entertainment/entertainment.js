...
async function fetchApi(url){
    try{
        ...
        sectionBox.setAttribute("style","display:flex;align-items:center;justify-content:center")
        ...
        for(i=0;i<length;i++){
            ...
            for(j=0;j<length;j++){
                ...
                sectionBox.setAttribute("style","justify-content: space-around;")
            }
        }
    }
    catch{
...
fetchApi("https://newsapi.org/v2/top-headlines?country=in&category=entertainment&pageSize=100&apiKey=0757bcb1bdd94500b9a25e3269bf6ac2");